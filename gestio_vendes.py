...
def mostrar_interficie_vendes(main_frame):
    ...
    tk.Label(main_frame, text="Registrar Vendes", font=("Arial", 16, "bold")).pack(pady=10)
    ...
    registrar_button = tk.Button(entrada_frame, text="Registrar Venda", command=registrar_venda, bg="green", fg="white")
